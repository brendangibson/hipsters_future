/**
*
* Dictionary for all the colors used in the app.
*
* Do not add colors elsewhere. Having them centrally is nice.
*/
export default {
  background: 'rgb(87,112,145)',
  titleText: 'rgba(137,246,250, 0.9)',
  text: 'rgba(126,226,230, 0.8)',
